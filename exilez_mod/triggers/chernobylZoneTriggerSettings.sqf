...
/* 1  Trigger Positions */   EZM_Kitas,             // The name of the array used to list all trigger position in the TriggerPositions.sqf file
...
EZM_Triggers = [EZM_Trigger_1,EZM_Trigger_2,EZM_Trigger_3,EZM_Trigger_4];
